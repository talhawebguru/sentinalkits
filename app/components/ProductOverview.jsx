            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-normal xl:px-[90px] lg:px-[40px] 2xl:max-w-[1440px] 2xl:mx-auto  lg:py-28 relative">
              <div className="lg:w-6/12 order-1 lg:order-0">
                <Image
                  src={Product2}
                  alt="Product"
                  className="w-[420px] h-[500px] shadow-xl mb-12 lg:mb-0"
                  width={420}
                  height={500}
                />
              </div>
              <div className="lg:w-6/12 mt-16 order-0 lg:order-1">
                <h3 className="text-[#0e0e0e] text-xl font-normal font-nohemi capitalize">
                  Product Overview
                </h3>
