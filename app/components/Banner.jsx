...
const Banner = () => {
  return (
    <>
    <div className='bg-CTA bg-no-repeat bg-cover bg-center  mt-32 xl:mx-[90px] lg:px-[40px] px-5 flex flex-wrap md:flex-nowrap pb-20 md:pb-0 2xl:max-w-[1440px] 2xl:mx-auto'>
